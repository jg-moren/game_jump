...
if (keyStates[32]) { 
if( pulos > 0 )impulso=0.5,pulos=0;
...
//-----------------------------------------------------------------------------------------------------------------
gluLookAt(coo_personagem[0]+00,coo_personagem[1]/2+15,coo_personagem[2]+10,coo_personagem[0],coo_personagem[1]+0,coo_personagem[2],0,1,0);
